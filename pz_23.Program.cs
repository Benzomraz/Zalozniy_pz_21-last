...
namespace pz_23
{
    ...
    public class UndeliveredPackage : Package
    {
    ...
    class Program
    {
        ...
        {
            UndeliveredPackage package1 = new UndeliveredPackage();
            UndeliveredPackage package2 = new UndeliveredPackage("Иван", "Петр");
            UndeliveredPackage package3 = new UndeliveredPackage("Анна", "Мария", "ул. Ленина, 5", DateTime.Now, "Документы", 0.5, "Отсутствие получателя");
